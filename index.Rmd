...
college: ---
university: ---
#university-logo: templates/logo-ub.pdf
university-logo-width: 5cm
submitted-text: ---
degree: ---
degreedate: ----
dedication: Untuk Para Pengembang `R Markdown` dan `Bookdown`
acknowledgements: |
  `r paste(readLines("front-and-back-matter/_acknowledgements.Rmd"), collapse = '\n  ')`
show-acknowledgements-in-toc: false
abstract-heading: "Sinopsis"
abstract: |
...
abbreviations-heading: Daftar Istilah
...
output:
  ...
  bookdown::bs4_book: 
    ...
    theme:
      primary: "#6D1919"
    repo: https://github.com/bangtedy/rstudio4eb
    pandoc_args: "--lua-filter=scripts_and_filters/colour_and_highlight.lua"
  bookdown::gitbook:
