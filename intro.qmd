...
Fitur *Help* di dalam RStudio adalah bagian yang sangat membantu untuk mempelajari cara menggunakan perintah-perintah tertentu di RStudio. Anda disarankan untuk mengeksplorasi lebih lanjut panel *Help* yang terletak di kanan bawah RStudio standar. Untuk antarmuka bantuan HTML yang berguna, ketik `help.start()`. Ini akan membuka tautan ke sejumlah manual, khususnya yang sangat direkomendasikan, 'An Introduction to R'. Selain itu ada banyak rujukan bagus untuk mempelajari R dan RStudio misalnya @crawleyBook2012, @wickhamDataScience2017 dan @verzaniGettingStartedRStudio2011. Banyak juga rujukan lain yang bisa diakses secara *online*.
